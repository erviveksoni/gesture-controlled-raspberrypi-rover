...
const char* ssid = "skynet-2ghz";
const char* wifi_password = "azure3006";

//const char* ssid = "twguest";
//const char* wifi_password = "dingy tiger slacks accustom pretzel";

// MQTT
// Make sure to update this for your own MQTT Broker!
const char* mqtt_server = "192.168.100.195";
//const char* mqtt_server = "10.136.124.239";
